...
import 'package:my_flutter/Layouts/Pages/page_start_screen.dart';
import 'package:my_flutter/Layouts/Widgets/widget_bird.dart';
import 'package:my_flutter/Layouts/Widgets/widget_barrier.dart';
import 'package:my_flutter/Layouts/Widgets/widget_cover.dart';
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Container(
            child: !kIsWeb
                ? Lottie.asset("assets/pics/loss.json", fit: BoxFit.cover)
                : Lottie.asset("assets/pics/loss.json",
                    package: 'my_flutter', fit: BoxFit.cover),
          ),
          actions: [
            gameButton(() {
              resetGame();
